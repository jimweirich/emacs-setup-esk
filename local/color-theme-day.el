...
;; Adapted-By: Yesudeep Mangalapilly / Jim Weirich
...
;;(add-to-list 'color-themes '(color-theme-day  "Day" "Jim Weirich"))

(provide 'color-theme-day)

;;; color-theme-day.el ends here
