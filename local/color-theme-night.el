  ...
  (let* ((aquamarine "Aquamarine")
    ...
    (color-theme-install
     `(color-theme-night
       ...
       (font-lock-constant-face ((t (:foreground ,(lighten mud-red 20)))))
       (font-lock-doc-string-face ((t (:foreground ,(lighten green 20)))))
       (font-lock-doc-face ((t (:foreground ,(lighten fire-brick 20)))))
       (font-lock-function-name-face ((t (:foreground ,(darken green 20)))))
       (font-lock-keyword-face ((t (:foreground ,(lighten purple 20)))))
       ...
       (font-lock-string-face ((t (:foreground ,slate-green))))
       (font-lock-type-face ((t (:foreground ,(lighten blue 70)))))
       (font-lock-variable-name-face ((t (:foreground ,gun-blue))))
