...
(custom-theme-set-faces
 'jw-dark
 '(default ((t (:family "Monaco" :foundry "apple" :width normal :height 220 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#f6f3e8" :background "#000000" :stipple nil :inherit nil))))
 '(cursor ((t (:background "#ff0000"))))
 '(fixed-pitch ((t (:family "Monospace"))))
 '(variable-pitch ((t (:family "Sans Serif"))))
 '(escape-glyph ((t (:weight bold :foreground "#ddaa6f"))))
 '(minibuffer-prompt ((t (:weight bold :box nil :foreground "yellow" :background "black"))))
 ...
 '(font-lock-constant-face ((t (:foreground "#d57d62" :weight bold))))
 '(font-lock-doc-face ((t (:foreground "moccasin" :inherit (font-lock-string-face)))))
 '(font-lock-function-name-face ((t (:weight bold :foreground "#cae682"))))
 '(font-lock-keyword-face ((t (:foreground "#00cc00" :weight bold))))
 ...
 '(font-lock-type-face ((t (:foreground "#b2b2ff" :weight bold))))
 '(font-lock-variable-name-face ((t (:foreground "#dea600" :weight bold))))
